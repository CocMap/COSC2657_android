...
//    private GoogleApiClient mGeoDataClient;
     ...
     */
    public PlaceAutocomplete(Context context, GeoDataClient geoDataClient,
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        results = mGeoDataClient.getAutocompletePredictions(constraint.toString(), mBounds, mPlaceFilter);
